...
- **Modern Threaded Comments & Prominent Triggers**: Interactive comment interface with primary "Add Comment" buttons, collapsible reply threads with count badges, zero-layout-shift iframe forms, and high-contrast dark mode rendering.
...
- **Interactive Mermaid 11 Diagrams & Client-Side Healing**: Embedded architecture flowcharts and protocol sequence diagrams with transparent zoom toolbar, automatic arrow normalization, and defensive browser-side syntax healing.
