...
describe('paced Blogger seeding', () => {
  it('builds a resume plan that skips completed fixture titles', () => { expect(createSeedPlan(['a', 'b', 'c'], [{ id: '1', title: 'a' }, { id: '2', title: 'b' }])).toEqual({ expected: 3, existing: 2, create: 1, skip: 2 }); });
